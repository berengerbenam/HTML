...
<body>
 <script type="text/javascript">
     alert("Bienvenue Dans Notre Site API et Cliquez sur Ok pour S'Inscrire Merci !!!");
  </script>
<header>
	<nav>
	<ul>
...
<section>
 <h1 class="titre">Bienvenue sur la page / FRONT-END Admin : Renseigner votre Login</h1>
</section>
<section>
